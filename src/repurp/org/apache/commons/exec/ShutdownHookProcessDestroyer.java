 ...
 *
 * @version $Id: ShutdownHookProcessDestroyer.java 1636056 2014-11-01 21:12:52Z
 *          ggregory $
 */
public class ShutdownHookProcessDestroyer implements ProcessDestroyer, Runnable {
	 ...
	 * {@code ProcessDestroyer} is registered as a shutdown hook. If removing a
	 * process results in an empty list, the {@code ProcessDestroyer} is removed
	 * as a shutdown hook.
	 */
	...
	/**
	 * Removes this {@code ProcessDestroyer} as a shutdown hook, uses reflection
	 * to ensure pre-JDK 1.3 compatibility
	 */
