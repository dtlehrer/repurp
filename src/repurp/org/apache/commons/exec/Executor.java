...
package repurp.org.apache.commons.exec;
...
public interface Executor {
	...
	/**
	 * Define the {@code exitValue} of the process to be considered successful.
	 * If a different exit value is returned by the process then
	 * {@link org.apache.commons.exec.Executor#execute(CommandLine)} will throw
	 * an {@link org.apache.commons.exec.ExecuteException}
	 *
	 * @param value
	...
	/**
	 * Checks whether {@code exitValue} signals a failure. If no exit values are
	 * set than the default conventions of the OS is used. e.g. most OS regard
	 * an exit code of '0' as successful execution and everything else as
	 * failure.
	 *
	 * @param exitValue
	...
	/**
	 * Set a custom the StreamHandler used for providing input and retrieving
	 * the output. If you don't provide a proper stream handler the executed
	 * process might block when writing to stdout and/or stderr (see
	...
	/**
	 * Get the watchdog used to kill of processes running, typically, too long
	 * time.
	 *
	 * @return the watchdog
	 */
	...
	/**
	 * Set the watchdog used to kill of processes running, typically, too long
	 * time.
	 *
	 * @param watchDog
	 *            the watchdog
	...
	/**
	 * Set the handler for cleanup of started processes if the main process is
	 * going to terminate.
	 *
	...
	/**
	 * Get the handler for cleanup of started processes if the main process is
	 * going to terminate.
	 *
	...
	/**
	 * Set the working directory of the created process. The working directory
	 * must exist when you start the process.
	 *
	 * @param dir
	 ...
	 *             execution of subprocess failed or the subprocess returned a
	 *             exit value indicating a failure
